...
<div class="row">
    ...
    <div class="col-md-12">
        <ul class="nav nav-tabs nav-tabs-highlight nav-justified">
            ...
            <li class="nav-item">
                <a href="{{ route('board.courses.students.index', $course) }}" class="nav-link active"> الطلبه  <span style="margin-right:10px;" class='badge bg-primary '> {{ $course_students }} </span> </a>
            </li>
            <li class="nav-item">

				...
				<div class="card-body">
					...
					<div class="mb-4">
						...
						<div class="row mb-3">
							...
							<div class="col-lg-10">
								<input type="text" name="name_ar" value="{{ $category->getTranslation('name' , 'ar') }}" class="form-control @error('name_ar')  is-invalid @enderror" required placeholder="اسم القسم">
								@error('name_ar')
								<p class='text-danger' > {{ $message }} </p>
								@enderror
							</div>
						...
						<div class="row mb-3">
							...
							<div class="col-lg-10">
								<input type="text" name="name_en" value="{{ $category->getTranslation('name' , 'en') }}" class="form-control @error('name_en')  is-invalid @enderror" required placeholder="اسم القسم">
								@error('name_en')
								<p class='text-danger' > {{ $message }} </p>
								@enderror
							</div>
						...
						<div class="row mb-3">
							...
							<div class="col-lg-10">
								<input type="text" name="description_ar" value="{{ $category->getTranslation('description' , 'ar') }}" class="form-control @error('desciption')  is-invalid @enderror" required placeholder="تفاصيل القسم">
						...
						<div class="row mb-3">
							...
							<div class="col-lg-10">
								<input type="text" name="description_en" value="{{ $category->getTranslation('description' , 'en') }}" class="form-control @error('desciption')  is-invalid @enderror" required placeholder="تفاصيل القسم">
						...
						<div class="row mb-3">
							<label class="col-lg-2 col-form-label pt-0"> صوره القسم الحاليه </label>
							<div class="col-lg-10">
								<img class='img-responsive img-thumbnail' src="{{ Storage::url('categories/'.$category->image) }}" alt="">
							</div>
						</div>
					</div>
				</div>

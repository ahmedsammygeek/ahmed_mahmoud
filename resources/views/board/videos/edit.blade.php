...
@section('page_title' , ' تعديل  الفديو ' )

@section('breadcrumb')
<a href="{{ route('board.videos.index') }}" class="breadcrumb-item"> الفديوهات </a>


<span class="breadcrumb-item active"> تعديل  الفديو  </span>
@endsection
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header bg-primary text-white">
				<h5 class="mb-0"> تعديل الفديو  </h5>
			</div>
            @livewire('board.videos.edit-video', ['video' => $video])

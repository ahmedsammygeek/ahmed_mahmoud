...
<div class="navbar navbar-expand-lg border-bottom py-2">
	<div class="container-fluid">
		<ul class="nav nav-tabs nav-tabs-highlight">
			...
			<li class="nav-item ">
				<a href="{{ route('board.students.payments.index' , $student ) }}" class="nav-link  rounded">
					<div class="d-flex align-items-center mx-lg-1">
						<i class="ph-calendar"></i>
			...
			<li class="nav-item ">
				<a href="{{ route('board.students.financial_reports.index' , $student ) }}" class="nav-link  active rounded" >
					<div class="d-flex align-items-center mx-lg-1">
						<i class="ph-gear"></i>

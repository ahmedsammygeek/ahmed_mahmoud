            ...
            <form class="" method="POST" action="{{ route('board.students.courses.update' , ['student' => $student_course->student_id , 'course' => $student_course->course_id ] ) }}" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="col-lg-12 col-form-label "> عرض اسم  الطالب </label>
                            <div class="col-lg-12">
                                <label class="form-check form-switch">
                                    <input type="checkbox" value='1' class="form-check-input"  name="show_name_on_viedo" @checked($student_course->show_name_on_viedo) >
                                    <span class="form-check-label"> @lang('courses.yes')  </span>
                                </label>
                            </div>
                        </div>

...
<a href="{{ route('board.students.courses.index' , ['student' => $student]) }}" class="breadcrumb-item"> @lang('students.student courses') </a>
...
<div class="content">
	@livewire('board.students.library.add-courses-to-student' , ['student' => $student] )
</div>

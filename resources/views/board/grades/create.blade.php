...
<span class="breadcrumb-item active"> @lang('grades.add new grade') </span>
@endsection
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header bg-primary text-white">
				<h5 class="mb-0"> @lang('grades.add new grade') </h5>
			</div>

			<form class="" method="POST" action="{{ route('board.grades.store') }}" enctype="multipart/form-data" >
				<div class="card-body">
					@csrf
					<div class="mb-4">

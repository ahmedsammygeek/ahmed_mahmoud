    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-4 mt-4">
            <div class="form-check form-switch  mb-2 center-block ">
                <input type="checkbox" class="form-check-input" name='online_library[{{ $course_id }}]' id="sc_lss_c" wire:model.live='online_library' checked>
                <label class=""> المكتبه الاكترونيه </label>
            </div>
        </div>


        <div class="col-sm-4">
            <label class="col-form-label "> @lang('students.purchase_price') </label>
            <input type="text" class='form-control' required wire:model.live='purchase_price' name='purchase_price[{{ $course_id }}]' >
        ...
        <div class="col-sm-4">
            ...
            <input type="text" class='form-control' required wire:model.live='paid' name='paid[{{ $course_id }}]' >
            @error('paid')
            <p class='is-invalid text-danger'> {{ $message }} </p>
            @enderror 
        </div>

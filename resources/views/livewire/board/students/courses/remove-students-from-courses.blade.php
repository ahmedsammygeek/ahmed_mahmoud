    ...
    <div class="col-md-12 collapse" id='filters' wire:ignore.self >
        <div class="card card-body">
            ...
            <div class="d-sm-flex align-items-sm-start mt-2">
                ...
                <div class="dropdown ms-sm-3  mb-sm-0">
                    <button  data-bs-toggle="modal" data-bs-target="#remove_courses_from_students_modal"  class="btn btn-primary "> remove </button>
                </div>
            </div>
        </div>
    </div>
...
<div id="remove_courses_from_students_modal" class="modal fade" wire:ignore.self tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form wire:submit="remove" class="form-horizontal">
...
<script>
    $(function() {
        ...
        Livewire.on('removed' , () => {
            $(document).find('#remove_courses_from_students_modal').modal('hide');
            swalInit.fire({
                text: "@lang('dashboard.removed successfully')" ,
                icon: 'success',
                toast: true,

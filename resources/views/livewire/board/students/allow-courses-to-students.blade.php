    ...
    <div class="col-md-12 collapse" id='filters' wire:ignore.self >
        <div class="card card-body">
            ...
            <div class="d-sm-flex align-items-sm-start mt-2">
                ...
                <div class="dropdown ms-sm-3  mb-sm-0">
                    <button  data-bs-toggle="modal" data-bs-target="#allow"  class="btn btn-primary "> allow </button>
                    <button  data-bs-toggle="modal" data-bs-target="#disable"  class="btn btn-primary "> disable </button>
                </div>
            </div>
        </div>
    </div>
            ...
            <form wire:submit="addStudnetsToCourses" class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class='form-control' wire:model.live='reason' >
                            @error('reason')
                            <p class='is-invalid text-danger'> {{ $message }} </p>
                            @enderror 
                        </div>

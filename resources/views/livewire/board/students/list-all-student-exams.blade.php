    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-primary text-white d-sm-flex align-items-sm-center ">
                <h5 class="mb-0"> @lang('exams.show all student exams') </h5>
                ...
                <table  class='table  table-responsive table-striped table-xs text-center '>
                    <thead>
                        <tr>
                            ...
                            <th> @lang('exams.started_at') </th>
                            <th> @lang('exams.ended_at') </th>
                            <th> @lang('exams.total_degree') </th>
                            <th> @lang('exams.is_finished') </th>
                            <th> @lang('exams.is_marked') </th>
                            <th> @lang('exams.marked_by') </th>
                    ...
                    <tbody class='text-center center-block' >
                        ...
                        <tr>
                            ...
                            <td>
                                @switch($exam->is_finished)
                                    @case(1)
                                    <span class='badge bg-danger' > @lang('dashboard.yes') </span>
                                    @break
                                    @case(0)
                                    <span class='badge bg-success' > @lang('dashboard.no') </span>
                                    @break
                                @endswitch 
                            </td>
                             <td>
                                @switch($exam->is_marked)
                                    @case(1)
                                    <span class='badge bg-danger' > @lang('dashboard.yes') </span>
                                    @break
                                    @case(0)
                            ...
                            <td>
                                <a class='btn btn-sm btn-primary ' title='مشاهده' href="{{ route('board.exam_students.show' , $exam->id ) }}" >  
                                    <i class="icon-eye "></i>  
                                </a>
                            </td>
                        </tr>

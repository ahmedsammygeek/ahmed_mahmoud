<div class="row">
    <div class="col-md-12">
        <a href='{{ route('board.universities.create') }}' class='btn btn-primary mb-2' style="float: left;">  <i class="icon-plus3 me-2"></i>  
            @lang('universities.add new university')
        </a>
    </div>
    <div class="col-md-12">
        <div class="card">
            ...
            <div class='card-body' >
                <table  class='table  table-responsive table-striped table-xs text-center '>
                    <thead>
                        <tr>
                            <th> # </th>
                            <th> @lang('universities.name in arabic') </th>
                            <th> @lang('universities.name in english') </th>
                            <th> @lang('dashboard.added by') </th>
                            <th> @lang('universities.status') </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td> {{ $i++ }} </td>
                            <td> {{ $university->getTranslation('name'  , 'ar') }} </td>
                            <td> {{ $university->getTranslation('name'  , 'en') }} </td>
                            ...
                            <td>
                                 <a href='{{ route('board.universities.show' , $university ) }}' class='btn btn-sm btn-primary ' title="@lang('dashboard.view')" >  <i class="icon-eye "></i>  </a>


                                <a href='{{ route('board.universities.edit' , $university ) }}' class='btn btn-sm btn-warning ' title="@lang('dashboard.edit')" >  <i class="icon-database-edit2 "></i>  </a>

                                <a wire:click="$dispatch('deleteConfirmation', '{{ $university->id }}')" class='btn btn-sm btn-danger  delete_item' title="@lang('dashboard.delete')" >  <i class="icon-trash "></i>  </a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>

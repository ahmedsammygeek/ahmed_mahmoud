        ...
        <table  class='table  table-responsive table-striped table-xs text-center '>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> {{ $student->deleted_at }} - <span class='text-muted'> {{ $student->deleted_at?->diffForHumans() }} </span> </td>
                    <td> {{ $student->deletedBy?->name }}  </td>
                    <td>

                        <a wire:click="$dispatch('restoreConfirmation', '{{ $student->id }}')" class='btn btn-sm btn-primary  delete_item' title="@lang('dashboard.restore')" >  <i class="icon-transmission "></i>  </a>
                        <a wire:click="$dispatch('deleteConfirmation', '{{ $student->id }}')" class='btn btn-sm btn-danger  delete_item' title="@lang('dashboard.delete')" >  <i class="icon-folder-remove "></i>  </a>
                    </td>
                </tr>
                @endforeach
            </tbody>

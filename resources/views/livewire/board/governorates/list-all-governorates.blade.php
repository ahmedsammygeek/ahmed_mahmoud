<div class="row">
    <div class="col-md-12">
        <a href='{{ route('board.governorates.create') }}' class='btn btn-primary mb-2' style="float: left;">  <i class="icon-plus3  me-2"></i>  إضافه محافظه جديده </a>
        ...
        <div class="card">
            <div class="card-body d-sm-flex">
                <div class="form-control-feedback form-control-feedback-start flex-grow-1 mb-3 mb-sm-0">
                    <input wire:model='search' type="text" class="form-control"  placeholder="البحث داخل المحافظات">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-primary text-white d-sm-flex align-items-sm-center ">
                <h5 class="mb-0"> عرض كافه المحافظات  </h5>
            ...
            <div class='card-body' >
                <table  class='table table-bordered table-responsive table-striped'>
                    <thead>
                        <tr>
                            <th> # </th>
                            <th> اسم المحافظه بالعربيه </th>
                            <th> اسم المحافظه بالانجليزيه </th>
                            <th> حاله المحافظه </th>
                            <th>  </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='{{ route('board.governorates.show' , $governorate ) }}' class='btn btn-sm btn-primary mb-2' title='مشاهده' >  <i class="icon-eye "></i>  </a>
                                <a href='{{ route('board.governorates.edit' , $governorate ) }}' class='btn btn-sm btn-warning mb-2' title='تعديل' >  <i class="icon-database-edit2 "></i>  </a>
                                <a wire:click="$emit('deleteConfirmation', '{{ $governorate->id }}')" class='btn btn-sm btn-danger mb-2 delete_item' title='حذف' >  <i class="icon-trash "></i>  </a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>

<div class="row">
    <div class="col-md-12">
        <a href='{{ route('board.groups.create') }}' class='btn btn-primary mb-2' style="float: left;">  <i class="icon-plus3 me-2"></i>  
            @lang('groups.add new group')
        </a>
    </div>
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-primary text-white d-sm-flex align-items-sm-center ">
                <h5 class="mb-0"> @lang('groups.show all groups') </h5>
                ...
                <table  class='table  table-responsive table-striped table-xs text-center '>
                    <thead>
                        <tr>
                            ...
                            <th> @lang('groups.course') </th>
                            <th> @lang('groups.teacher') </th>
                            <th> @lang('groups.maxmimam student number') </th>
                            <th> @lang('groups.options') </th>
                        </tr>
                    </thead>
                    <tbody>
                        @php
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href='{{ route('board.groups.show' , $group ) }}' class='btn btn-sm btn-primary ' title="@lang('dashboard.view')" >  <i class="icon-eye "></i>  </a>
                                <a href='{{ route('board.groups.edit' , $group ) }}' class='btn btn-sm btn-warning ' title="@lang('dashboard.edit')" >  <i class="icon-database-edit2 "></i>  </a>
                                <a wire:click="$dispatch('deleteConfirmation', '{{ $group->id }}')" class='btn btn-sm btn-danger  delete_item' title="@lang('dashboard.delete')" >  <i class="icon-trash "></i>  </a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>

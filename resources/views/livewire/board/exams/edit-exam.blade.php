<form action="{{ route('board.exams.update' , $exam ) }}" method="POST"  enctype="multipart/form-data" >
    <div class="card-body">
        @csrf
        @method('PATCH')
        <div class="mb-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-10">
                    <div class="input-group">
                        <input type="text" name="title_ar" value="{{ $exam->getTranslation('title' , 'ar' ) }}" class="form-control" placeholder="@lang('exams.title in arabic')">
                        <input type="text" name="title_en" value="{{ $exam->getTranslation('title' , 'en' ) }}" class="form-control" placeholder="@lang('exams.title in english')">
                    </div>
                    <div class="input-group">
                        <div class="col-md-6">
                            @error('title_ar')
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-10">
                    <div class="input-group">
                        ...
                        <input type="text" name='date' class="form-control daterange-time" value="{{$exam->starts_at->format('m/d/Y h:i a') }} - {{ $exam->ends_at->format('m/d/Y h:i a') }}" >
                    </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="col-lg-12">
                        <input type="text" name="duration" value="{{ $exam->duration }}" class="form-control @error('duration')  is-invalid @enderror"  >
                        @error('duration')
                        <p class='text-danger' > {{ $message }} </p>
                        @enderror
                    </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-4">
                    <div class="mb-3">
                        ...
                        <input type="number" name='question_limit' value="{{ $exam->question_limit }}" class="form-control" required > 
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mb-3">
                        <label class="form-label"> @lang('exams.student pass degree') </label>
                        <input type="number" name='pass_degree' value="{{ $exam->pass_degree }}" class="form-control" required >
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="mb-3">
                        <label class="form-check form-switch mt-4">
                            <input type="checkbox" value='1' class="form-check-input" name="can_student_see_result" {{ $exam->can_student_see_result ? 'checked' : '' }} >
                ...
                <div class="col-lg-4">
                    <div class="mb-3">
                        ...
                        <input type="number" name='min_degree_to_re_exam' value="{{ $exam->min_degree_to_re_exam }}" class="form-control" required > 
                    </div>
                </div>
                @endif
            </div>
            ...
            <div class="row mb-3"  >
                ...
                <div class="col-lg-10">
                    <select name="questions[]" wire:model.live='selected_questions' multiple class="form-control listbox-basic">
                        @foreach ($this->questions as $question)
                        <option value="{{ $question->id }}" {{ in_array($question->id, $selected_questions) ? 'selected="selected"' : '' }} > {{ $question->getTranslation('content' , 'ar' ) }} </option>
                        @endforeach
                    </select>
                </div>
            </div>

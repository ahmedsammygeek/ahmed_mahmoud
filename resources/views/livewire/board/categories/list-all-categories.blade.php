<div class="row">
    <div class="col-md-12">
        <a href='{{ route('board.categories.create') }}' class='btn btn-primary mb-2' style="float: left;">  <i class="icon-plus3  me-2"></i>  إضافه قسم جديد </a>
        ...
        <div class="card">
            <div class="card-body d-sm-flex">
                <div class="form-control-feedback form-control-feedback-start flex-grow-1 mb-3 mb-sm-0">
                    <input wire:model='search' type="text" class="form-control"  placeholder="البحث داخل الاقسام">
            ...
            <div class='card-body' >
                <table  class='table table-bordered table-responsive table-striped'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td> {{ $i++ }} </td>
                            <td> <img class='img-preview rounded img-thumbnail' src="{{ Storage::url('categories/'.$category->image) }}" alt=""> </td>
                            ...
                            <td>
                                <a href='{{ route('board.categories.show' , $category ) }}' class='btn btn-sm btn-primary mb-2' title='مشاهده' >  <i class="icon-eye "></i>  </a>
                                <a href='{{ route('board.categories.edit' , $category ) }}' class='btn btn-sm btn-warning mb-2' title='تعديل' >  <i class="icon-database-edit2 "></i>  </a>
                                <a wire:click="$emit('deleteConfirmation', '{{ $category->id }}')" class='btn btn-sm btn-danger mb-2 delete_item' title='حذف' >  <i class="icon-trash "></i>  </a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>

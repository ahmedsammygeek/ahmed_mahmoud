...
Route::group(['prefix' => 'student/v1'  , 'middleware' => ['locale' , 'check_if_blocked', 'api' ] ], function() {
    ...
    Route::group(['middleware' => ['auth:student']  ], function() {
        ...
        Route::group(['middleware' => 'phone_verification'  ], function() {
            ...
            Route::get('/announcements/{announcement}/viewed' , [HomeController::class , 'markAnnouncementAsDownloaded'] );

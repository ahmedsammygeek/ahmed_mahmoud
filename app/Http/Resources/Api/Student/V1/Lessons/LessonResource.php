...
class LessonResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'show_phone_on_viedo' => $this->show_phone_on_viedo  ? (bool)$this->show_phone_on_viedo : false ,
            'speak_user_phone' => $this->speak_user_phone  ? (bool)$this->speak_user_phone : false ,

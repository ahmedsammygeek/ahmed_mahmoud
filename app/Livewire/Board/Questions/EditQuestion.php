...
class EditQuestion extends Component
{
    ...
    public function mount() {
        ...
        $this->course_id = $this->question->course_id;
        $this->lesson_id = $this->question->lesson_id;
        $this->degree = $this->question->degree;
        $this->calculators = $this->question->is_calculators == 1 ? true : false ;
    ...
    public function render()
    {
        ...
        return view('livewire.board.questions.edit-question' , compact('courses') );
    }
}
